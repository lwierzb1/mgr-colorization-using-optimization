from src.colorization_algorithm.colorization_using_optimization.image.affinity_cpu_solver import AffinityCpuSolver
from src.colorization_algorithm.colorization_using_optimization.image.neighbor_cpu_solver import NeighborCpuSolver
