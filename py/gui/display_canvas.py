...
import py.observer.observer
from py.colorization_algorithm.colorization_using_optimization.image import image_colorizer_multiprocess
from py.toolkit import image_processing


class DisplayCanvas(tk.ttk.Frame, py.observer.observer.Observer):
