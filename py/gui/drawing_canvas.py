...
from py.colorization_algorithm.color_transfer.image import ct_async_task
from py.behaviour import update_behaviour
...
from py.toolkit import gui, image_processing
...
class DrawingCanvas(ttk.Frame):
    ...
    def _restore_state_ct(self, data):
        ...
        self.__colorize_ct(image_processing.read_image(data['ref']),
    ...
    def __load_image(self, e):
        ...
        if colorization_algorithm == 'CUO':
            ...
            if self._image_path is not None:
                ...
                self.__show_default_image()
                return
            self.__colorize_ct(image_processing.read_image(self._state['ref']),
