...
class ConfigPicker(ttk.Frame):
    ...
    def _init_mode(self):
        ...
        ttk.Label(self, text="Select mode").grid(column=0,
    ...
    def _init_linear_algorithm(self):
        ...
        ttk.Label(self, text="Select linear algorithm").grid(column=0,
                                                             row=1, padx=10, pady=25, sticky='w')
        ...
        linear_algorithm_chooser.grid(column=1, row=1, sticky='e', padx=(0, 10))

        linear_algorithm_chooser.current(2)

    def _init_colorization_algorithm(self):
        self._colorization_algorithm = tk.StringVar()
        ttk.Label(self, text="Select colorization algorithm").grid(column=0,
        ...
        colorization_algorithm_chooser.grid(column=1, row=2, sticky='e', padx=(0, 10))
    ...
    def _init_process_number(self):
        ...
        ttk.Label(self, text=label_content).grid(column=0,
    ...
    def _init_jacobi_approximation(self):
        ttk.Label(self, text="Specify Jacobi approximation (If needed)").grid(column=0,
                                                                              row=4, padx=10, pady=25, sticky='w')
    ...
    def _init_max_frames_per_section(self):
        ttk.Label(self, text="Specify max video frames per section (If needed)").grid(column=0,
