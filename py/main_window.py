...
import py.config.singleton_config
import py.gui.config_picker
import py.gui.video_display_canvas
import py.gui.video_drawing_canvas
import py.toolkit.gui
import py.toolkit.image_processing
from py.config.singleton_config import SingletonConfig
from py.gui.display_canvas import DisplayCanvas
from py.gui.drawing_canvas import DrawingCanvas
from py.gui.styled_observer_button import StyledObserverButton
from py.gui.video_display_canvas import VideoDisplayCanvas
from py.gui.video_drawing_canvas import VideoDrawingCanvas
from py.toolkit.gui import create_info_confirm_window
from py.toolkit.image_processing import write_image, bgr_to_rgb
...
class MainWindow:
    ...
    def _pick_config(self):
        ...
        py.gui.config_picker.ConfigPicker(window, self._callback)
